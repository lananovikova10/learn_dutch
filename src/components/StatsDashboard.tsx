  ...
  return (
    <div className={`card-bg rounded-xl p-6 ${className}`}>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        {/* Total Answers */}
        <div className="rounded-lg p-4 text-center hover:shadow-sm transition-all duration-200"
             style={{ backgroundColor: 'var(--stat-box-bg)' }}
             onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'var(--stat-box-hover)'}
             onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'var(--stat-box-bg)'}>
      ...
      {progress.totalAnswers > 0 && (
        <div className="mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {/* Total Hints Used */}
            <div className="rounded-lg p-3 text-center" style={{ backgroundColor: 'var(--stat-box-bg)' }}>
          ...
          {hintStats.recentHintTrend !== 0 && (
            <div className="mt-4 rounded-lg p-3 text-center" style={{ backgroundColor: 'var(--stat-box-bg)' }}>
              <div className="text-xs text-secondary uppercase tracking-wide mb-4">
                Recent Hint Trend
              </div>
              <div className={`text-sm font-medium ${hintStats.recentHintTrend > 0 ? 'text-orange-400' : 'text-green-400'}`}>
      ...
      <div className="mb-4">
        ...
        {knownWords.length === 0 ? (
          <div className="rounded-lg p-4 text-center" style={{ backgroundColor: 'var(--stat-box-bg)' }}>
            <div className="text-secondary text-sm">
              No words marked as known yet. Click the checkbox on word cards to mark words you already know!
            </div>
          </div>
        ) : (
          <div className="rounded-lg p-4 max-h-48 overflow-y-auto" style={{ backgroundColor: 'var(--stat-box-bg)' }}>
      ...
      <div className="rounded-lg p-4" style={{ backgroundColor: 'var(--stat-box-bg)' }}>
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <span className="text-primary font-medium text-sm">Last Session</span>
          </div>
          <div className="text-secondary text-sm">
